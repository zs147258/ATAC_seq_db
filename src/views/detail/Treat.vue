    ...
    <el-form ref="form" :model="filter" label-width="120px">
      <div class="formRow1">
        ...
        <el-form-item label="Gene_chr :">
          <el-input v-model="filter.gene_chr"  clearable style="width: 100px;"
            ></el-input>
        </el-form-item>

        <el-form-item label="Gene_id :">
          <el-input v-model="filter.gene_id" placeholder="e.g. ENSG00000127616.21" clearable style="width: 200px;"></el-input>
        </el-form-item>
        <el-form-item label="Transcript_id :">
          <el-input v-model="filter.transcript_id" placeholder="e.g. ENST00000587988.5" clearable style="width: 200px;"></el-input>
        </el-form-item>
      </div>
        ...
        <el-collapse-item name="1">
          ...
          <template #title>
            <i class="ti-layers"></i>&nbsp; Results <sup><span data-html="true" data-toggle="tooltip"
                ...
                title="The meaning of columns is explained in the Help page."><i
